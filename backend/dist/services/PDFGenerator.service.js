 ...
 */
export async function generatePolicySchedule(policyData) {
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.fontSize(9)
                .font('Helvetica')
                .fillColor('#666666')
                .text('This policy is issued based on the information provided by the policyholder.', { align: 'left', width: 500 });
            doc.moveDown(0.3);
            doc.text('The policyholder must notify the insurer of any material changes to the risk within 14 days.', { align: 'left', width: 500 });
            doc.moveDown(0.3);
            doc.text('Claims must be reported within 30 days of the incident.', { align: 'left', width: 500 });
            doc.moveDown(0.3);
            doc.text('This document is a legally binding contract between the policyholder and Awash Insurance.', { align: 'left', width: 500 });
            doc.moveDown(1);
            // ==================== SIGNATURES ====================
